...
If you need to redact a phone number because one of your users asked you to delete his/her account and data, you can use the Redact API to remove this phone number from all communication records (known as "CDRs") in our system.
